...
namespace Scheduler.API.Migrations
{
    ...
    [Migration("20180726184913_LeadTypeRemoval")]
    partial class LeadTypeRemoval
    {
            ...
            modelBuilder.Entity("Scheduler.Model.Customer", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 7, 26, 14, 49, 13, 631, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Scheduler.Model.Schedule", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 7, 26, 14, 49, 13, 650, DateTimeKind.Local));
