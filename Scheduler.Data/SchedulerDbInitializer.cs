...
namespace Scheduler.Data
{
    public class SchedulerDbInitializer
    {
        ...
        private static void InitializeSchedules()
        {
            ...
            /*
            if (!context.Jobs.Any()) {
                Job job_01 = new Job { JobType = 0, AddressId = 15, CustomerId = 2 };
                context.Add(job_01);
                context.SaveChanges();
            }
            
            if (!context.WorkDescriptions.Any()) {
                WorkDescription workDescription_01 = new WorkDescription { JobId = 12, WorkType = 0, Revenue = 34 };
                context.Add(workDescription_01);
                context.SaveChanges();
            }
            if (!context.EndUsers.Any()) {
                EndUser endUser_01 = new EndUser
                {
            ...
            {
                PhoneNumber phoneNumber_01 = new PhoneNumber { CustomerId = 1, Number = "3059114545" };
                PhoneNumber phoneNumber_02 = new PhoneNumber { CustomerId = 1, Number = "3059114545" };
                PhoneNumber phoneNumber_03 = new PhoneNumber { CustomerId = 3, Number = "3059114545" };
                context.PhoneNumbers.Add(phoneNumber_01);
                context.PhoneNumbers.Add(phoneNumber_02);
                context.PhoneNumbers.Add(phoneNumber_03);                
            ...
            {
                Address address_03 = new Address { Address1 = "16578 Nw 34 st", City = "Miami", CustomerId = 1, State = "FL", ZipCode = "33015" };
                Address address_04 = new Address { Address1 = "14578 Sw 31 st", City = "Kendall", CustomerId = 2, State = "FL", ZipCode = "33012" };
                context.Addresses.Add(address_03);
                context.Addresses.Add(address_04);

                context.SaveChanges();

          }
            if (!context.Customers.Any()) {
                Customer customer_03 = new Customer {
                    FirstName = "Juan",
                    LastName = "Medina",
                    CompanyName = "DB"
                };
                Customer customer_04 = new Customer
                {
                    FirstName = "Juan",
                    LastName = "Perez",
                    CompanyName = "Microsoft"
                };
                context.Customers.Add(customer_03);
                context.Customers.Add(customer_04);
                context.SaveChanges();
            }
            */
